        ...
        <div className="p-4 w-[512px] rounded  flex flex-col items-center bg-gray-700 gap-5">
          ...
          <div className="rounded overflow-hidden w-full">
            ...
            <button
              id="button"
              onClick={copy}
              className=" w-1/5 text-white  bg-blue-700 py-2 px-2 hover:bg-blue-800"
            >
              Copy
            </button>
          </div>
          ...
          <div className=" text-left flex flex-col justify-start p-2 w-full gap-3">
            ...
            <div className="flex items-center gap-2">
              ...
              />
              <label htmlFor="uppercase" className="text-white font-semibold ">
                Use Uppercase
              </label>
            </div>
            {/* lowercase */}
            <div className="flex items-center gap-2">
              ...
              />
              <label htmlFor="lowercase" className="text-white font-semibold ">
                Use Lowercase
              </label>
            </div>
            {/* numbe */}
            ...
            <div className="flex items-center gap-2">
              ...
              />
              <label htmlFor="symbol" className="text-white font-semibold ">
                Use Symbol
              </label>
            </div>
          </div>
